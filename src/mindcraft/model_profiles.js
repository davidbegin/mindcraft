 ...
 *
 * Profile ids are the model id with dots flattened, plus the preset id. Existing ids
 * (`gpt-5-6-terra-balanced`) are referenced by contest presets and saved colonies, so
...
export const CURSOR_FAMILIES = [
    ...
    { id: 'gemini_pro', model: 'gemini-3.1-pro', param: null, presets: [] },
