...
export const BOT_MODEL_LINEUPS = Object.freeze({
    ...
    sonnet: Object.freeze({
        id: 'sonnet',
        title: 'Claude Sonnet ladder',
        blurb: 'Five Claude Sonnet 5 effort levels — mid Anthropic ladder.',
        profileIds: Object.freeze([
            'claude-sonnet-5-fast',
            'claude-sonnet-5-balanced',
            'claude-sonnet-5-thorough',
            'claude-sonnet-5-deep',
            'claude-sonnet-5-max',
        ]),
    }),
    openai: Object.freeze({
        id: 'openai',
        title: 'OpenAI pack',
        blurb: 'Luna, Terra, Sol, and GPT-5.5 across quick and heavier presets.',
        profileIds: Object.freeze([
            'gpt-5-6-luna-instant',
            'gpt-5-6-luna-fast',
            'gpt-5-6-terra-fast',
    ...
    chinese: Object.freeze({
        ...
        blurb: 'Kimi, GLM, DeepSeek, and Qwen — Asia lab showcase.',
        profileIds: Object.freeze([
    ...
    openrouter: Object.freeze({
        ...
        blurb: 'Models Cursor does not ship: Muse, DeepSeek, Qwen, Mistral, Llama 4.',
        profileIds: Object.freeze([
            'deepseek-deepseek-v4-flash',
            'meta-muse-spark-1-2',
