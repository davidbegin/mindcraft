export const CONTEST_GAME_PRESETS = Object.freeze({
    diamond_race: Object.freeze({
        ...
        prompt:
            'CONTEST: First Diamond. You are in a freshly reset quarry arena with an iron pickaxe, food, and torches. Dig and search for diamond ore. Do not help rivals. First diamond wins.',
        rules: Object.freeze({
            type: 'diamond_race',
            winItem: 'diamond',
    ...
    tower_battle: Object.freeze({
        ...
        durationMs: 5 * 60_000,
        prompt:
            'CONTEST: Tallest Tower. You are in a freshly reset flat arena with building blocks, food, and a wooden sword. You have five minutes. Build the tallest tower you can. PVP is on — attack rivals and knock them down. Highest solid tower wins.',
        rules: Object.freeze({
            type: 'tower_battle',
            pvp: true,
            metrics: Object.freeze([
                Object.freeze({ path: 'height', weight: 1, direction: 'maximize' }),
            ]),
        }),
        metadata: Object.freeze({
            arena: 'simple-arena-v1',
