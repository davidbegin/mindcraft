const settings = {
    ...
    "record_bot_view": false, // auto-record bot's third-person follow view to mp4 in bots/<name>/recordings on spawn. Recording can also be toggled per-agent in the web UI. Requires ffmpeg.
